...
module.exports = {
    ...
    command_display_user_balance: async function(userID,userName,messageType,msg){
        ...
        if(!isUserRegistered){
            //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.accountNotRegistered,false,false,false,false); 
            return;
        }
    ...
    command_clear_chat: async function(userName,messageType,userRole,msg) {
        if(messageType === 'dm'){
            //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.clear.no,false,false,false,false);
            return;
        }
        if(userRole < 2){
            //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.notAllowedCommand,false,false,false,false);
            return;
        }
    ...
    command_credit_deposits: async function(manuallyFired,userName,messageType,userRole,msg){
        ...
        if(!databaseTransactions.length){
            if(manuallyFired == 1){
                //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
                chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.special,false,config.messages.creditdeposits.manually,[[config.messages.creditdeposits.deposits,countCreditedDeposits,false]],false,false,false,false,false);
                return;
            }else{
    ...
    command_credit_stakes: async function(manuallyFired,userName,messageType,userRole,msg){
        ...
        if(!transactionsToCredit.length){
            if(manuallyFired == 1){
                //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
                chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.special,false,config.messages.creditstakes.manually,[[config.messages.creditstakes.transactions,countCreditedStakes,false]],false,false,false,false,false);
                return;
            }else{
        ...
        // Original calculations produce inconsistent ammounts for BlockCoin/NovaCoin forks
    ...
    command_display_user_deposit_address: async function(userID,userName,messageType,msg){
        ...
        if(!userDepositAddress){
            ...
            // Display the address
            //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.success,false,config.messages.deposit.title,[[config.messages.deposit.address,userDepositAddress,false]],config.messages.deposit.description,false,config.wallet.thumbnailIcon,'http://chart.apis.google.com/chart?cht=qr&chs=300x300&chl='+userDepositAddress+'&choe=UTF-8&chld=L',false);
        }   
    },
    ...
    command_donate: function(userID,userName,messageType,msg){
        chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.success,false,config.messages.donate.title,[[config.messages.donate.address,config.wallet.donateAddress,false]],config.messages.donate.description,false,config.wallet.thumbnailIcon,'http://chart.apis.google.com/chart?cht=qr&chs=300x300&chl='+config.wallet.donateAddress+'&choe=UTF-8&chld=L',false);
        return;
    },
    ...
    command_drop: async function(userID,userName,messageType,msg,partTwo,partThree,partFour,partFive){
       ...
       if(messageType === 'dm'){
        chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.drop.private,false,false,false,false);
        return;
        }
        ...
        if(dropTime < config.bot.dropMinSeconds){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.drop.minTime+' `'+config.bot.dropMinSeconds+'`.',false,false,false,false);
            return;
        }
        if(dropTime > config.bot.dropMaxSeconds){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.drop.maxTime+' `'+config.bot.dropMaxSeconds+'`.',false,false,false,false);
            return;
        }
        // Check if user is registered
        var isUserRegistered = await user.user_registered_check(userID);
        ...
        if(Big(dropAmount).gt(Big(userBalance))){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.drop.big+' `'+Big(dropAmount).toFixed(8)+' '+config.wallet.coinSymbolShort+'` '+config.messages.drop.big1+' `'+Big(userBalance).toFixed(8)+' '+config.wallet.coinSymbolShort+'`'+config.messages.drop.big2,false,false,false,false);
            return;
        }
        // Check min drop amount
        if(Big(dropAmount).lt(Big(config.bot.minDropValue))){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.drop.min+' `'+Big(config.bot.minDropValue).toFixed(8)+' '+config.wallet.coinSymbolShort+'` ',false,false,false,false);
            return;
        }
            ...
            case 'phrase':
                ...
                phraseCollector.on('end', collected => {
                    ...
                    (async () => {
                        ...
                        //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
                        chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.success,false,config.messages.drop.titleSent,[[config.messages.drop.amount,Big(dropAmount).toFixed(8)+' '+config.wallet.coinSymbolShort,true],[config.messages.drop.rounded,Big(valueToRemoveFromUser).toFixed(8)+' '+config.wallet.coinSymbolShort,true],[config.messages.drop.users,dropCollectedUsers.length,true],[config.messages.drop.each,Big(dropSingleUserAmount).toFixed(8)+' '+config.wallet.coinSymbolShort,true]],config.messages.drop.description,false,false,false,false);
                        chat.chat_reply(msg,'normal',false,messageType,false,false,false,false,'https://discord.gg/tX85tUf6d9',false,false,false,false);
                        // List rained users
                        var listUsers = '';
                        var userCount = 0;
                        for (var i = 0 ; i < dropCollectedUsers.length ; ++i){
        ...
        if(!latestDeposits){
            ...
            for (var i = 0 ; i < latestDeposits.length ; ++i){
                ...
                if(i == latestDeposits.length-1 && manuallyFired == 1)
                    //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
                    chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.special,false,config.messages.getdeposits.manually,[[config.messages.getdeposits.deposits,countDeposits,false]],false,false,false,false,false);
    ...
    command_get_stakes: async function(manuallyFired,userName,messageType,userRole,msg){
        ...
        if(!transactionsToCheck.length){
            if(manuallyFired == 1){
                chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.special,false,config.messages.getstakes.manually,[[config.messages.getstakes.transactions,countTransactionsToCheck,false]],false,false,false,false,false);
                return;
            }else{
    ...
    command_help: function(userID,userName,messageType,userRole,msg){
        ...
        chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.normal,false,config.messages.help.title,enabledUserCommands,false,false,false,false,false);
        return;
    },
        ...
        switch(partTwo) {
            ...
            case 'deposits':
                    ...
                    if(!latestUserDeposits.length > 0){
                        chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.history.deposits.no,false,false,false,false);
                        return;
                    }
            ...
            case 'withdrawals':
                    ...
                    if(!latestUserWithdrawals.length > 0){
                        chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.history.withdrawals.no,false,false,false,false);
                        return;
                    }
                    var replyResult = [];
                    for (var i = 0 ; i < latestUserWithdrawals.length ; ++i){
                        ...
                        if(i == latestUserWithdrawals.length-1){
                            //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
                            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.success,false,config.messages.history.withdrawals.title,replyResult,config.messages.history.withdrawals.description,false,false,false,false);
                            return;
                        }
                    }
                return;
            ...
            case 'payments':
                    ...
                    if(!latestUserPayments.length > 0){
                        chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.history.payments.no,false,false,false,false);
                        return;
                    }
                    var replyResult = [];
                    for (var i = 0 ; i < latestUserPayments.length ; ++i){
                        ...
                        if(i == latestUserPayments.length-1){
                            //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
                            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.success,false,config.messages.history.payments.title,replyResult,config.messages.history.payments.description,false,false,false,false);
                        }
                    }
                return;
            default:
    ...
    command_user_notify: async function(userID,userName,messageType,msg,partTwo){
        ...
        if(partTwo === 'on'){
            ...
            //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.success,false,config.messages.notify.title,false,config.messages.notify.enabled,false,false,false,false);
            return;
        }
        if(partTwo === 'off'){
            ...
            //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.success,false,config.messages.notify.title,false,config.messages.notify.disabled,false,false,false,false);
            return;
        }
        return;
    },
    ...
    command_rain: async function(userID,userName,messageType,msg,partTwo,partThree,partFour,serverUsers,activeUsers){
        ...
        if(partTwo === 'all'){
            ...
            if(databaseUsersCount === 0 || databaseUsersCount == undefined){
                ...
                chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.tip.no,false,false,false,false);
                return; 
            }
            ...
            if(Big(tipAmount).lt(minServerUsersTipAmount)){
                ...
                chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.rain.minimum+' `'+Big(minServerUsersTipAmount).toFixed(8)+'` '+config.messages.rain.minimum1+' `'+databaseUsersCount+'` '+config.messages.rain.minimum2,false,false,false,false);
                return;
            }
        ...
        if(partTwo === 'online'){
            ...
            if(Big(tipAmount).lt(minActiveUsersTipAmount)){
                ...
                chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.rain.minimum+' `'+Big(minActiveUsersTipAmount).toFixed(8)+'` '+config.messages.rain.minimum1+' `'+activeUsersCount+'` '+config.messages.rain.minimum2,false,false,false,false);
                return;
            }
            // Calculate tip for each user and round down value to loose no own sat
            var down = 0
        ...
        if(partTwo === 'random'){
            ...
            if(Big(tipAmount).lt(minServerActiveUsersTipAmount)){
                ...
                chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.rain.minimum+' `'+Big(minServerActiveUsersTipAmount).toFixed(8)+'` '+config.messages.rain.minimum1+' `'+partFour+'` '+config.messages.rain.minimum2,false,false,false,false);
                return;
            }
            // Calculate tip for each user and round down value to loose no own sat
            var down = 0
    ...
    command_user_register: async function(userID,userName,messageType,msg){
        ...
        if(isUserRegistered){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.register.already,false,false,false,false);
            return;
        }
    ...
    command_stake: async function(userID,userName,messageType,msg,partTwo){
        ...
        if(Big(stakeAmount).lt(Big(config.staking.minStake))){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.stake.min+' `'+Big(config.staking.minStake).toFixed(8)+' '+config.wallet.coinSymbolShort+'` ',false,false,false,false);
            return;
        }
        ...
        // Return success message
        //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
        chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.success,false,config.messages.stake.title,[[config.messages.stake.amount,Big(stakeAmount).toFixed(8)+' '+config.wallet.coinSymbolShort,true]],config.messages.stake.description,false,false,false,false);
    },
    ...
    command_tip: async function(userID,userName,messageType,msg,partTwo,partThree){
        ...
        if(messageType === 'dm'){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.tip.private,false,false,false,false);
            return;
        }
        ...
        if(!check.check_valid_discord_id(tipUser)){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.tip.notvalid,false,false,false,false);
            return;
        }
        ...
        if(Big(userID).eq(tipUser)){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.tip.self,false,false,false,false);
            return;
        }
        // Check min tip amount
        if(Big(tipAmount).lt(Big(config.wallet.minTipValue))){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.tip.min+' `'+Big(config.wallet.minTipValue).toFixed(8)+' '+config.wallet.coinSymbolShort+'` ',false,false,false,false);
            return;
        }
        // Get user balance
        var userBalance = await user.user_get_balance(userID);
        ...
        // Return success message
        //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
        chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.success,false,config.messages.tip.title,[[config.messages.tip.user,'<@'+tipUser+'>',true],[config.messages.tip.amount,Big(tipAmount).toFixed(8)+' '+config.wallet.coinSymbolShort,true]],config.messages.tip.description,false,false,false,false);
    },
    ...
    command_unstake: async function(userID,userName,messageType,msg,partTwo){
        ...
        if(Big(unstakeAmount).lt(Big(config.staking.minUnstake))){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.unstake.min+' `'+Big(config.staking.minUnstake).toFixed(8)+' '+config.wallet.coinSymbolShort+'` ',false,false,false,false);
            return;
        }
        ...
        if(seconds_from_current_unstake < config.staking.lockTime){
            ...
            */
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.unstake.locked,false,config.messages.unstake.left+' `'+duration.days() + ' '+config.messages.unstake.leftdays+' '+duration.hours() + ' '+config.messages.unstake.lefthours+' '+duration.minutes() + ' '+config.messages.unstake.leftminutes+' '+duration.seconds() + ' '+config.messages.unstake.leftseconds+'`'+config.messages.unstake.left2,false,false,false,false);
            return;
        }
        // Set value BigInt and from minus to plus
        ...
        // Return success message
        //msg,replyType,replyUsername,senderMessageType,replyEmbedColor,replyAuthor,replyTitle,replyFields,replyDescription,replyFooter,replyThumbnail,replyImage,replyTimestamp
        chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.success,false,config.messages.unstake.title,[[config.messages.unstake.amount,Big(unstakeAmount).toFixed(8)+' '+config.wallet.coinSymbolShort,true]],config.messages.unstake.description + unstakeReply,false,false,false,false);
    },
    ...
    command_withdraw: async function(userID,userName,messageType,msg,partTwo,partThree){
        ...
        if(Big(withdrawAmount).lt(Big(config.wallet.minWithdrawalValue))){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.withdraw.min+' `'+Big(config.wallet.minWithdrawalValue).toFixed(8)+' '+config.wallet.coinSymbolShort+'` ',false,false,false,false);
            return;
        }
        ...
        if(!isAddressValid){
            chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,config.messages.title.error,false,config.messages.withdraw.notvalid,false,false,false,false);
            return;
        }
        // Get user balance
        var userBalance = await user.user_get_balance(userID);
    ...
    fire_command: function(msg,userID,userName,messageType,userRole,partOne,partTwo,partThree,partFour,partFive,serverUser,activeUsers){
        switch(partOne) {
            ...
            case 'withdraw':
                ...
                return;
            default:
                return chat.chat_reply(msg,'embed',"<@" + userID + ">",messageType,config.colors.error,false,false,false,config.messages.notValidCommand,false,false,false,false);
        }
    }
